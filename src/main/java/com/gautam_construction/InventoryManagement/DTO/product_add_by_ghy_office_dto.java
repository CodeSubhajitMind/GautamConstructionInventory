...
public class product_add_by_ghy_office_dto{
	...
	public product_add_by_ghy_office_dto() {
		super();
	...
	public product_add_by_ghy_office_dto(Integer prod_id, String prod_name,String prod_unit, String prod_type, String quantity, String invoice_no,
	...
	@Override
	public int hashCode() {
		return Objects.hash(bill_no, invoice_date, invoice_no, prod_id, prod_name, prod_type, prod_unit, quantity,
				remarks, sub_admin, vehicle_no, vendor_name);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		product_add_by_ghy_office_dto other = (product_add_by_ghy_office_dto) obj;
		return Objects.equals(bill_no, other.bill_no) && Objects.equals(invoice_date, other.invoice_date)
	...
	public String toString() {
		return "product_add_by_ghy_office_dto [prod_id=" + prod_id + ", prod_name=" + prod_name + ", prod_unit="
				...
				+ ", sub_admin=" + sub_admin + ", remarks=" + remarks + ", bill_no=" + bill_no + "]";
	}
