...
public class product_exit_by_misc_dto {
	...
	public product_exit_by_misc_dto(Integer prod_id, String prod_name, String quantity, String challan_no,
			String exit_date, String work_name, String receiving_person) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(challan_no, exit_date, prod_id, prod_name, quantity, receiving_person, work_name);
	}
	@Override
	...
	public String toString() {
		return "product_exit_by_misc_dto [prod_id=" + prod_id + ", prod_name=" + prod_name + ", quantity=" + quantity
