...
public class product_exit_by_contractor_dto {
	...
	public product_exit_by_contractor_dto(Integer prod_id, String prod_name, String prod_unit, String prod_type, String quantity, String challan_no,
			String exit_date, String contractor_name, String receiving_person,String sub_admin) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(challan_no, contractor_name, exit_date, prod_id, prod_name, prod_type, prod_unit, quantity,
				receiving_person, sub_admin);
	}
	@Override
	...
	public String toString() {
		return "product_exit_by_contractor_dto [prod_id=" + prod_id + ", prod_name=" + prod_name + ", prod_unit="
				+ prod_unit + ", prod_type=" + prod_type + ", quantity=" + quantity + ", challan_no=" + challan_no
				+ ", exit_date=" + exit_date + ", contractor_name=" + contractor_name + ", receiving_person="
				+ receiving_person + ", sub_admin=" + sub_admin + "]";
	}
